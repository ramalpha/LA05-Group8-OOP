...
public final class Connect {
	...
	private final String DATABASE = "businessinventory"; // change with the database name that you use (after file.sql import) -> WAJIB DIUBAH ke nama database yang ingin dipakai (di PHPMyAdmin)
	private final String HOST = "localhost:3306"; // change with your MySQL host, the default port is 3306 -> WAJIB DI CEK APAKAH PORT "3306"
